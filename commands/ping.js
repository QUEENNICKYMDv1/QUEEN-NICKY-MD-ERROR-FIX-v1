...
async (Void, citel) => {
    ...
    await Void.sendMessage(citel.chat, { text: `*ᴘɪɴɢ*\nʟᴏᴀᴅɪɴɢ: [${loadingBar}] 100%`, edit: key });

    // Wait for a brief moment (you can customize this delay)
    await Secktor.sleep(1000);

    // Send the final ping message
    return await Void.sendMessage(citel.chat, { text: `*Qᴜᴇᴇɴ ɴɪᴄᴋʏ ᴍᴅ ᴘᴏɴɢ: ${pingValue} ms*\n*©ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍʀ ᴅᴜᴍɪᴅᴜ*` });
});
